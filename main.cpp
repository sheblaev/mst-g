...
int main(int argc, char **argv) 
{
    ...
    printf("%s: vertices = %d edges = %lld trees = %zu nIters = %d MST performance min = %.4f avg = %.4f max = %.4f MTEPS\n", 
            inFilename, g.n, (long long)g.m, trees_mst.size(), nIters, min_perf, avg_perf, max_perf);
